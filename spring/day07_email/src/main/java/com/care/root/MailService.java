...
public class MailService {
	...
	public void send3(String user_id, HttpSession session, String email) {
		String[] userKey = UUID.randomUUID().toString().split("-");
		String str = "";
		for(int i = 0; i < 4; i++) {
			str += userKey[i];
		}
		...
		String text = "<h2>인증 해주세요</h2> <a href='http://localhost:8081/root/check?user_id="+user_id+"&userKey="+str+"'>인증하기</a>";
